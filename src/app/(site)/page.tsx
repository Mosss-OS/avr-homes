...
const HERO_IMAGES = [
  { src: heroLekki.src, alt: "Civic Towers, Lekki — Lagos luxury skyline" },
  { src: heroDubai.src, alt: "Luxury high-rise development" },
  { src: prop1.src, alt: "Modern luxury apartment interior" },
  { src: prop3.src, alt: "Premium residential home" },
  { src: prop5.src, alt: "Elegant property exterior" },
];
    ...
    <>
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6">
          <div className="mx-auto max-w-4xl text-center text-white">
            <h1 className="font-display font-semibold leading-[0.95] text-3xl sm:text-4xl md:text-6xl lg:text-8xl">
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        <div className="flex flex-wrap justify-center gap-3">
          {CATEGORIES.map((cat) => (
            <Link key={cat.label} href={hrefWithSearch("/properties", cat.search)}
        ...
        <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            {agents.slice(0, 8).map((a) => (
              <Link key={a.id} href="/agents" className="flex items-center gap-3 rounded-2xl border border-border bg-card px-4 py-3 transition hover:-translate-y-0.5 hover:shadow-[var(--shadow-elevated)]">
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:py-16">
        <div className="flex items-end justify-between">
          ...
          <Link href={hrefWithSearch("/properties", { purpose: "buy" })}
      ...
      <section className="bg-secondary/40 py-12 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <ScrollableSection className="gap-4 pb-2">
            {CITIES.map((c) => (
              <Link key={c.name} href={hrefWithSearch("/properties", { city: c.name })}
...
const CITIES = [
  { name: "Lagos", desc: "Lekki, Ikoyi, VI, Banana Island", image: "/assets/cities/lagos.jpg" },
  { name: "Abuja", desc: "Maitama, Wuse, Asokoro, Gwarinpa", image: "/assets/cities/abuja.jpg" },
  { name: "Port Harcourt", desc: "GRA, Old GRA, Elelenwo", image: "/assets/cities/ph.jpg" },
  { name: "Ibadan", desc: "Bodija, Jericho, Ibadan North", image: "/assets/cities/ibadan.jpg" },
  { name: "Benin City", desc: "GRA, Oredo, Ikpoba Okha", image: "/assets/cities/benin-city.jpg" },
  { name: "Enugu", desc: "Enugu City, Nsukka, Awgu", image: "/assets/cities/enugu.jpg" },
  { name: "Asaba", desc: "Cable Point, Okpanam, Ibusa", image: "/assets/cities/asaba.jpg" },
  { name: "Owerri", desc: "Worlomasi, Aladinma, Ikenegbu", image: "/assets/cities/owerri.jpg" },
  { name: "Awka", desc: "Agu Awka, Amawbia, Umuawulu", image: "/assets/cities/awka.jpg" },
  { name: "Abeokuta", desc: "Ibara, Adigbe, Lantoro", image: "/assets/cities/abeokuta.jpg" },
  { name: "Warri", desc: "Effurun, Udu, Osubi", image: "/assets/cities/warri.jpg" },
